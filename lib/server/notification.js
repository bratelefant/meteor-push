const sendNotification = (
    ...
    android: {
      ...
      data: {
        ...
        notification_priority:
          mongoNote.notificationPriority || defaults.notificationPriority,
  ...
  fcmConnections
    ...
    .catch((error) => {
      if (isDebug) {
        console.log("FCM Sending Error: ", JSON.stringify(error, null, 4), "Token: ", note.token);
      }
    });
};
